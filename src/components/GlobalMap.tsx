  ...
  return (
    <div className="relative flex items-center justify-center overflow-hidden bg-gradient-to-b from-blue-50 to-blue-100 rounded-xl py-20 md:py-28 w-full">
      ...
      <div className="relative z-10 flex flex-col items-center">
        <div className="h-40 w-40 md:h-60 md:w-60 bg-gradient-to-br from-earth-blue via-earth-teal to-earth-green rounded-full flex items-center justify-center shadow-xl animate-float">
